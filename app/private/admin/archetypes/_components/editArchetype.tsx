...
const EditArchetype = ({ archetype, open, onOpenChange }: EditArchetypeProps) => {
	...
	useEffect(() => {
		...
		setDetailedDescription(archetype.detailedDescription);
	}, [archetype]);
	...
	const onSubmit = async () => {
		...
		const [validated, error] = inlineCatch(() => editArchetypeSchema.parse({ id: archetype.id, name, description, detailedDescription }));
